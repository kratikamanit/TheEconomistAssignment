...
//		cwf.selectJobSector(po.readproperty("Objectrepo.properties", "jobs_bysector"), "Humanitarian");
	...
	public void validateCreateAccount(String fname, String lname, String email, String pwd) {
		cwf.launch("https://jobs.economist.com/");
		cwf.click(po.readproperty("Objectrepo.properties", "create_acc_link"));
		cwf.verifyTitle("Register | Jobs.Economist.com");
		cwf.verifyCurrentURL("https://jobs.economist.com/register/");
		cwf.isDisplayed(po.readproperty("Objectrepo.properties", "create_acc_page_block"));
		...
		cwf.click(po.readproperty("Objectrepo.properties", "signout_link"));
	}
	...
	public void validateSignIn(String email, String pwd) {
		...
		log.info(" Successfully Navigated to Sign in Page ");
		log.info(" ***************************************** ");
		cwf.entertext(po.readproperty("Objectrepo.properties", "signin_email_input"), email);
		cwf.entertext(po.readproperty("Objectrepo.properties", "signin_pwd_input"), pwd);
		cwf.click(po.readproperty("Objectrepo.properties", "signin_button"));
		cwf.isDisplayed(po.readproperty("Objectrepo.properties", "signin_title"));
		log.info("Current logged in user is : " + cwf.getText(po.readproperty("Objectrepo.properties", "loggedin_user")));
		cwf.click(po.readproperty("Objectrepo.properties", "signout_link"));
		cwf.isDisplayed(po.readproperty("Objectrepo.properties", "sign_in_link"));
		cwf.isDisplayed(po.readproperty("Objectrepo.properties", "create_acc_link"));
	}
}
